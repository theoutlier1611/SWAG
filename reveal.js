...
camera.position.set(0, 0, 20); // Closer for better visibility
camera.lookAt(0, 0, 0);
...
const icosahedronGeometry = new THREE.IcosahedronGeometry(6, 1); // Increased from 4 to 6
...
const crystalGeometry = new THREE.IcosahedronGeometry(3, 0); // Increased from 2 to 3
...
let orbitAngle = 0;
const orbitRadius = 12; // Increased from 8 to 12
const orbitSpeed = 0.003; // Slower for more elegant movement
...
function createTextMeshes(font) {
    ...
    const visionGeometry = new TextGeometry(visionString, { 
        font: font, 
        size: 0.9, // Increased from 0.6 to 0.9
    ...
    const swagGeometry = new TextGeometry('SWAG', { 
        font: font, 
        size: 1.2, // Increased from 0.8 to 1.2
        height: 0.18, // Increased depth
        curveSegments: 8,
        bevelEnabled: true,
        bevelThickness: 0.05,
        bevelSize: 0.03
